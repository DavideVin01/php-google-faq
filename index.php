...
$paragraphs = [
    ...
    [
        ...
        <li class="smANld">La versione dei termini che regola il nostro rapporto, che può variare in base alle leggi locali.</li>
        ...
        <section>
            <?php foreach ($paragraphs as $paragraph) : ?>
                <div class="py-3">
                    ...
                    <h4 class="py-3"><strong><?= $paragraph['title'] ?></strong></h4>
                    <p><?= $paragraph['text'] ?></p>
                </div>
            <?php endforeach; ?>
        </section>
